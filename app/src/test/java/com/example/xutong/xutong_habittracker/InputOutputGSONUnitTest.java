...
//    public InputOutputGSONUnitTest(Class activityClass) {
//        super(activityClass);
//    }
    ...
    public void testSaveInFile() throws InvalidHabitException, FileNotFoundException{
        ...
        Assert.assertFalse(isFileExistent(addEditHabitActivity, ioGson.jsonFileName(habit)));
        ioGson.saveInFile(habit);
        Log.i("test", "test");
        Assert.assertTrue(isFileExistent(addEditHabitActivity, ioGson.jsonFileName(habit)));
    }
